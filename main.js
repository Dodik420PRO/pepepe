...
CAMERA
==================================================== */
const CAMERA_HOME = new THREE.Vector3(0, 1.2, 4.5);
const CAM_ROOMS = {
  quantum:  { pos: new THREE.Vector3(0, 1.2, 4.5), target: new THREE.Vector3(0, 1.0, 0) },
  biomed:   { pos: new THREE.Vector3(0, 1.2, 4.5), target: new THREE.Vector3(0, 1.0, 0) },
  physics:  { pos: new THREE.Vector3(0, 1.2, 4.5), target: new THREE.Vector3(0, 1.0, 0) },
};
