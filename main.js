...
const CAM_Y=1.8, CAM_Z=14, CAM_LOOK_Y=0.5, CAM_X_MIN=-14, CAM_X_MAX=14;
...
function loop() {
  ...
  controls.update();
   camX += (camXTarget - camX) * 0.08; camera.position.set(camX, CAM_Y, CAM_Z); camera.lookAt(camX * 0.3, CAM_LOOK_Y, 9);
