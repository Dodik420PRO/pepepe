...
const CAM_Y=5, CAM_Z=16, CAM_LOOK_Y=0, CAM_X_MIN=-14, CAM_X_MAX=14;
let camX=0, camXTarget=0, camZ=16, camZTarget=16, isDragging=false, dragStartX=0, dragCamStartX=0;
